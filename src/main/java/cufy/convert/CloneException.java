...
public class CloneException extends ConvertException {
	/**
	 * Constructs a new class clone exception with null as its detail message. The cause is not initialized, and may subsequently be initialized
	...
	/**
	 * Constructs a new class clone exception with the specified detail message. The cause is not initialized, and may subsequently be
	...
	/**
	 * Constructs a new class clone exception with the specified detail message and cause. Note that the detail message associated with cause is
	 * not automatically incorporated in this class clone exception's detail message.
	 *
