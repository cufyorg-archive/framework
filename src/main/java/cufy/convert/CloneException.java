...
public class CloneException extends ConvertException {
	/**
	 * Constructs a new class clone exception with null as its detail message. The cause is not initialized, and may subsequently be initialized by a
	...
	/**
	 * Constructs a new class clone exception with the specified detail message. The cause is not initialized, and may subsequently be initialized by
	...
	/**
	 * Constructs a new class clone exception with the specified detail message and cause. Note that the detail message associated with cause is not
	 * automatically incorporated in this class clone exception's detail message.
	 *
	...
	/**
	 * Constructs a new class clone exception with the specified cause and a detail message of (cause==null ? null : cause.toString()) (which
	...
	/**
	 * Constructs a new class clone exception with the specified detail message, cause, suppression enabled or disabled, and writable stack trace
	 * enabled or disabled.
	 *
