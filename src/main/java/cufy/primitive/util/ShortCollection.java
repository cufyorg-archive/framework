...
import cufy.primitive.lang.ShortIterable;
import cufy.primitive.util.function.ShortConsumer;
import cufy.primitive.util.function.ShortPredicate;
...
/**
 * A collection specialized for {@code short} values.
 *
 * @author LSafer
 * @version 0.1.5
...
public interface ShortCollection extends PrimitiveCollection<
		...
		>, ShortIterable {
	@Override
	default boolean add(Short element) {
		return this.addShort(element);
	}

	@Override
	default boolean contains(Object object) {
		return object instanceof Short && this.contains((short) object);
	}

	@Override
	default boolean remove(Object object) {
		return object instanceof Short && this.removeShort((short) object);
	}
	...
	default boolean removeIf(Predicate<? super Short> predicate) {
		...
		return this.removeIf(
				predicate instanceof ShortPredicate ?
