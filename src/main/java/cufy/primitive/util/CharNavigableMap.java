...
import cufy.primitive.util.function.CharBiConsumer;
import cufy.primitive.util.function.CharBinaryOperator;
...
public interface CharNavigableMap<
		ENTRY_SET extends Set<Map.Entry<Character, Character>>
		...
		CharCollection,
		CharMap<ENTRY_SET>,
		CharSortedMap<ENTRY_SET>,
		CharNavigableMap<ENTRY_SET>
		>, CharSortedMap<ENTRY_SET> {
	@Override
	...
	@Override
	default CharNavigableMap<ENTRY_SET> headMap(Character endKey, boolean inclusive) {
	...
	@Override
	default CharNavigableMap<ENTRY_SET> subMap(Character beginKey, boolean beginInclusive, Character endKey, boolean endInclusive) {
		return this.subMap((char) beginKey, beginInclusive, (char) endKey, endInclusive);
	}

	@Override
	default CharNavigableMap<ENTRY_SET> tailMap(Character beginKey, boolean inclusive) {
		return this.tailMap((char) beginKey, inclusive);
	}

	/**
	 * Returns the least key greater than or equal to the given key, or {@code default char value}
	 * if there is no such key.
	 *
	 * @param key the key.
	 * @return the least key greater than or equal to {@code key}, or {@code default char value} if
	...
	/**
	 * Returns the greatest key less than or equal to the given key, or {@code default char value}
	 * if there is no such key.
	 *
	 * @param key the key
	 * @return the greatest key less than or equal to {@code key}, or {@code default char value} if
	 * 		there is no such key.
	 * @since 0.1.5 ~2020.09.03
	 */
	 ...
	 * @since 0.1.5 ~2020.09.03
	 */
	CharNavigableMap<ENTRY_SET> headMap(char endKey, boolean inclusive);

	/**
	 * Returns the least key strictly greater than the given key, or {@code default char value} if
	 * there is no such key.
	 *
	 * @param key the key.
	 * @return the least key greater than {@code key}, or {@code default char value} if there is no
	 * 		such key.
	 * @since 0.1.5 ~2020.09.03
	 */
	...
	/**
	 * Returns the greatest key strictly less than the given key, or {@code default char value} if
	 * there is no such key.
	 *
	 * @param key the key.
	 * @return the greatest key less than {@code key}, or {@code default char value} if there is no
	 * 		such key.
	 * @since 0.1.5 ~2020.09.03
	 */
	 ...
	 * @since 0.1.5 ~2020.09.03
	 */
	CharNavigableMap<ENTRY_SET> subMap(char beginKey, boolean beginInclusive, char endKey, boolean endInclusive);
	 ...
	 * @since 0.1.5 ~2020.09.03
	 */
	CharNavigableMap<ENTRY_SET> tailMap(char beginKey, boolean inclusive);
}
