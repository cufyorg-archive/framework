...
import cufy.primitive.util.function.CharToDoubleFunction;
import cufy.primitive.util.function.CharToIntFunction;
import cufy.primitive.util.function.CharToLongFunction;
import cufy.primitive.util.function.CharUnaryOperator;
...
public interface CharComparator extends PrimitiveComparator<
	 ...
	 */
	@SuppressWarnings("LambdaUnfriendlyMethodOverload")
	static CharComparator comparingDouble(CharToDoubleFunction function) {
	 ...
	 */
	@SuppressWarnings("LambdaUnfriendlyMethodOverload")
	static CharComparator comparingInt(CharToIntFunction function) {
		Objects.requireNonNull(function, "function");
	 ...
	 */
	@SuppressWarnings("LambdaUnfriendlyMethodOverload")
	static CharComparator comparingLong(CharToLongFunction function) {
		Objects.requireNonNull(function, "function");
		return (CharComparator & Serializable) (v, o) -> Long.compare(
	...
	default CharComparator thenComparingDouble(ToDoubleFunction<? super Character> function) {
		...
		return this.thenComparingDouble(
				function instanceof CharToDoubleFunction ?
	...
	@Override
	default CharComparator thenComparingDouble(CharToDoubleFunction function) {
	...
	default CharComparator thenComparingInt(ToIntFunction<? super Character> function) {
		...
		return this.thenComparingInt(
				function instanceof CharToIntFunction ?
	...
	@Override
	default CharComparator thenComparingInt(CharToIntFunction function) {
		Objects.requireNonNull(function, "function");
	...
	default CharComparator thenComparingLong(ToLongFunction<? super Character> function) {
		...
		return this.thenComparingLong(
				function instanceof CharToLongFunction ?
	...
	@Override
	default CharComparator thenComparingLong(CharToLongFunction function) {
