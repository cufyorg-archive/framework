 ...
 * byte}. Unlike most other functional interfaces, {@code ByteBiConsumer} is expected to operate via
 * side-effects.
 * <p>
 * This is a {@code functional interface} whose functional method is {@link #accept(byte, byte)}.
 *
 * @author LSafer
 * @version 0.1.5
...
public interface ByteBiConsumer {
	/**
	 * Return a composed {@code ByteBiConsumer} that performs, in sequence, this operation followed
	 ...
	 * @since 0.1.5 ~2020.09.03
	 */
	void accept(byte value, byte other);
}
