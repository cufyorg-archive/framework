 ...
 * boolean}. Unlike most other functional interfaces, {@code BooleanBiConsumer} is expected to
...
public interface BooleanBiConsumer {
	/**
	 * Return a composed {@code BooleanBiConsumer} that performs, in sequence, this operation
	 ...
	 * @since 0.1.5 ~2020.09.03
	 */
	void accept(boolean value, boolean other);
}
