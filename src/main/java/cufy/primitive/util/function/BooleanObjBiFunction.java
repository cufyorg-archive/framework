...
/**
 * Represents a function that accepts a {@code boolean}-valued and a {@code object}-valued argument.
 * This is the {@code (boolean, reference)} specialization of {@link
 ...
 */
@FunctionalInterface
public interface BooleanObjBiFunction<U, R> {
	/**
