...
/**
 * Represents a predicate (boolean-valued function) of two {@code int}-valued argument. This is the
 * {@code int}-consuming primitive type specialization of {@link java.util.function.BiPredicate}.
 * <p>
 * This is a {@code functional interface} whose functional method is {@link #test(int, int)}.
 *
 * @author LSafer
 * @version 0.1.5
...
public interface IntBiPredicate {
	 ...
	 * @since 0.1.5 ~2020.09.03
	 */
	boolean test(int value, int other);
}
