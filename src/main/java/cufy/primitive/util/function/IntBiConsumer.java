...
/**
 * Represents an operation that accepts two {@code int}-valued arguments and returns no result. This
 * is the primitive type specialization of {@link java.util.function.BiConsumer} for {@code int}.
 * Unlike most other functional interfaces, {@code IntBiConsumer} is expected to operate via
 * side-effects.
 * <p>
 * This is a {@code functional interface} whose functional method is {@link #accept(int, int)}.
 *
 * @author LSafer
 * @version 0.1.5
...
public interface IntBiConsumer {
	/**
	 * Return a composed {@code IntBiConsumer} that performs, in sequence, this operation followed
	 ...
	 * @since 0.1.5 ~2020.09.03
	 */
	void accept(int value, int other);
}
