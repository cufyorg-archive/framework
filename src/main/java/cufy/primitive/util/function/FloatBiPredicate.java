...
/**
 * Represents a predicate (boolean-valued function) of two {@code float}-valued argument. This is
 * the {@code float}-consuming primitive type specialization of {@link
 * java.util.function.BiPredicate}.
 * <p>
 * This is a {@code functional interface} whose functional method is {@link #test(float, float)}.
 *
 * @author LSafer
 * @version 0.1.5
...
public interface FloatBiPredicate {
	 ...
	 * @since 0.1.5 ~2020.09.03
	 */
	boolean test(float value, float other);
}
