...
/**
 * Represents a predicate (boolean-valued function) of two {@code byte}-valued argument. This is the
 * {@code byte}-consuming primitive type specialization of {@link java.util.function.BiPredicate}.
 * <p>
 * This is a {@code functional interface} whose functional method is {@link #test(byte, byte)}.
 *
 * @author LSafer
 * @version 0.1.5
...
public interface ByteBiPredicate {
	 ...
	 * @since 0.1.5 ~2020.09.03
	 */
	boolean test(byte value, byte other);
}
