...
/**
 * Represents a function that accepts a {@code int}-valued and a {@code object}-valued argument.
 * This is the {@code (int, reference)} specialization of {@link java.util.function.BiFunction}.
 * <p>
 * This is a {@code functional interface} whose functional method is {@link #apply(int, Object)}.
 *
