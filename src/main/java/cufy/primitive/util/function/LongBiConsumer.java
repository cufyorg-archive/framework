 ...
 * long}. Unlike most other functional interfaces, {@code LongBiConsumer} is expected to operate via
 * side-effects.
 * <p>
 * This is a {@code functional interface} whose functional method is {@link #accept(long, long)}.
 *
 * @author LSafer
 * @version 0.1.5
...
public interface LongBiConsumer {
	/**
	 * Return a composed {@code LongBiConsumer} that performs, in sequence, this operation followed
	 ...
	 * @since 0.1.5 ~2020.09.03
	 */
	void accept(long value, long other);
}
