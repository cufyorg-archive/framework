...
/**
 * Represents a predicate (boolean-valued function) of two {@code long}-valued argument. This is the
 * {@code long}-consuming primitive type specialization of {@link java.util.function.BiPredicate}.
 * <p>
 * This is a {@code functional interface} whose functional method is {@link #test(long, long)}.
 *
 * @author LSafer
 * @version 0.1.5
...
public interface LongBiPredicate {
	 ...
	 * @since 0.1.5 ~2020.09.03
	 */
	boolean test(long value, long other);
}
