...
/**
 * Represents a predicate (boolean-valued function) of two {@code short}-valued argument. This is
 * the {@code short}-consuming primitive type specialization of {@link
 * java.util.function.BiPredicate}.
 * <p>
 * This is a {@code functional interface} whose functional method is {@link #test(short, short)}.
 *
 * @author LSafer
 * @version 0.1.5
...
public interface ShortBiPredicate {
	 ...
	 * @since 0.1.5 ~2020.09.03
	 */
	boolean test(short value, short other);
}
