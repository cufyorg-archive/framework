...
/**
 * Represents an operation that accepts two {@code double}-valued arguments and returns no result.
 * This is the primitive type specialization of {@link java.util.function.BiConsumer} for {@code
 * double}. Unlike most other functional interfaces, {@code DoubleBiConsumer} is expected to operate
 * via side-effects.
 * <p>
 * This is a {@code functional interface} whose functional method is {@link #accept(double,
 * double)}.
 *
 * @author LSafer
 * @version 0.1.5
...
public interface DoubleBiConsumer {
	/**
	 * Return a composed {@code DoubleBiConsumer} that performs, in sequence, this operation
	 ...
	 * @return a composed {@code DoubleBiConsumer} that performs in sequence this operation followed
	 ...
	 * @since 0.1.5 ~2020.09.03
	 */
	void accept(double value, double other);
}
