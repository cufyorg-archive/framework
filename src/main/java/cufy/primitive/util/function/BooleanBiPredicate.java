...
/**
 * Represents a predicate (boolean-valued function) of two {@code boolean}-valued argument. This is
 * the {@code boolean}-consuming primitive type specialization of {@link
 * java.util.function.BiPredicate}.
 * <p>
 * This is a {@code functional interface} whose functional method is {@link #test(boolean,
 * boolean)}.
 *
 * @author LSafer
 * @version 0.1.5
...
public interface BooleanBiPredicate {
	 ...
	 * @since 0.1.5 ~2020.09.03
	 */
	boolean test(boolean value, boolean other);
}
