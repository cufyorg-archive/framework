 ...
 * float}. Unlike most other functional interfaces, {@code FloatBiConsumer} is expected to operate
 * via side-effects.
 * <p>
 * This is a {@code functional interface} whose functional method is {@link #accept(float, float)}.
 *
 * @author LSafer
 * @version 0.1.5
...
public interface FloatBiConsumer {
	/**
	 * Return a composed {@code FloatBiConsumer} that performs, in sequence, this operation followed
	 ...
	 * @since 0.1.5 ~2020.09.03
	 */
	void accept(float value, float other);
}
