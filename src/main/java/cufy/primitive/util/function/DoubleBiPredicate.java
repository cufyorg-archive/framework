...
/**
 * Represents a predicate (boolean-valued function) of two {@code double}-valued argument. This is
 * the {@code double}-consuming primitive type specialization of {@link
 * java.util.function.BiPredicate}.
 * <p>
 * This is a {@code functional interface} whose functional method is {@link #test(double, double)}.
 *
 * @author LSafer
 * @version 0.1.5
...
public interface DoubleBiPredicate {
	 ...
	 * @since 0.1.5 ~2020.09.03
	 */
	boolean test(double value, double other);
}
