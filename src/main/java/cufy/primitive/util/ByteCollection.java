...
import cufy.primitive.lang.ByteIterable;
import cufy.primitive.util.function.ByteConsumer;
import cufy.primitive.util.function.BytePredicate;
...
/**
 * A collection specialized for {@code byte} values.
 *
 * @author LSafer
 * @version 0.1.5
...
public interface ByteCollection extends PrimitiveCollection<
	...
	default boolean add(Byte element) {
		return this.addByte(element);
	}

	@Override
	default boolean contains(Object object) {
		return object instanceof Byte && this.contains((byte) object);
	}

	@Override
	default boolean remove(Object object) {
		return object instanceof Byte && this.removeByte((byte) object);
	}
	...
	default boolean removeIf(Predicate<? super Byte> predicate) {
		...
		return this.removeIf(
				predicate instanceof BytePredicate ?
