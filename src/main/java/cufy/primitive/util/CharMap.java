...
/**
 * A map specialized for {@code char} values.
 *
...
public interface CharMap<
	 ...
	 * @return the new value associated with the specified key, or {@code default char value} if
	 * 		none.
	 ...
	 * 		default char value} if the computed value is null.
	 * @throws UnsupportedOperationException if the {@code put} operation is not supported by this
	 *                                       map.
	 * @since 0.1.5 ~2020.09.03
	 */
	 ...
	 * @since 0.1.5 ~2020.09.03
	 */
	default char getOrDefaultChar(char key, char defaultValue) {
	 ...
	 * @return the new value associated with the specified key, or {@code default char value} if no
	...
	/**
	 * If the specified key is not already associated with a value, associates it with the given
	 * value and returns {@code default char value}, else returns the current value.
	 *
	 * @param key   key with which the specified value is to be associated.
	 * @param value value to be associated with the specified key.
	 * @return the previous value associated with the specified key, or {@code default char value}
	 * 		if there was no mapping for the key. (A {@code default char value} return can also indicate
	 * 		that the map previously associated {@code default char value} with the key.)
	 * @throws UnsupportedOperationException if the {@code put} operation is not supported by this
	 *                                       map.
	...
	default char putCharIfAbsent(char key, char value) {
		...
		//will return `default char value`
	...
	/**
	 * Returns the value to which the specified key is mapped, or {@code default char value} if this
	 * map contains no mapping for the key.
	 * <p>
	 * A return value of {@code default char value} does not <i>necessarily</i> indicate that the
	 * map contains no mapping for the key; it's also possible that the map explicitly maps the key
	 * to {@code default char value}. The {@link #containsKey(char) containsKey} operation may be
	 * used to distinguish these two cases.
	 *
	 * @param key the key whose associated value is to be returned.
	 * @return the value to which the specified key is mapped, or {@code default char value} if this
	 * 		map contains no mapping for the key.
	 * @since 0.1.5 ~2020.09.02
	 */
	 ...
	 * @param key   key with which the specified value is to be associated.
	 * @param value value to be associated with the specified key.
	 * @return the previous value associated with {@code key}, or {@code default char value} if
	 * 		there was no mapping for {@code key}.(A {@code default char value} return can also indicate
	 * 		that the map previously associated {@code default char value} with {@code key}).
	 * @throws UnsupportedOperationException if the {@code put} operation is not supported by this
	 *                                       map.
	 * @throws IllegalArgumentException      if some property of the specified key or value prevents
	 *                                       it from being stored in this map.
	 ...
	 * key to {@code default char value}.
	 * <p>
