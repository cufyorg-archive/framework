...
import cufy.primitive.lang.LongIterable;
...
/**
 * A collection specialized for {@code long} values.
 *
 * @author LSafer
 * @version 0.1.5
...
public interface LongCollection extends PrimitiveCollection<
	...
	default Stream<Long> parallelStream() {
		return this.parallelLongStream().boxed();
	}

	@Override
	default boolean remove(Object object) {
		return object instanceof Long && this.removeLong((long) object);
	}
	...
	default boolean removeIf(Predicate<? super Long> predicate) {
		...
		return this.removeIf(
				predicate instanceof LongPredicate ?
	...
	/**
	 * Returns a sequential {@code LongStream} with this collection as its source.
	 *
	 * @return a sequential {@code LongStream} over the elements in this collection.
	 * @since 0.1.5 ~2020.09.01
	 */
	...
	/**
	 * Returns a possibly parallel {@code LongStream} with this collection as its source. It is
	 * allowable for this method to return a sequential stream.
	 *
	 * @return a possibly parallel {@code LongStream} over the elements in this collection.
	 * @since 0.1.5 ~2020.09.01
	 */
