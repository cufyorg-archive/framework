...
public interface CharSortedMap<
	...
	@Override
	default CharSortedMap<ENTRY_SET> headMap(Character endKey) {
	...
	@Override
	default CharSortedMap<ENTRY_SET> subMap(Character beginKey, Character endKey) {
		return this.subMap((char) beginKey, (char) endKey);
	}

	@Override
	default CharSortedMap<ENTRY_SET> tailMap(Character beginKey) {
	 ...
	 * @since 0.1.5 ~2020.09.03
	 */
	CharSortedMap<ENTRY_SET> headMap(char endKey);
	 ...
	 * @since 0.1.5 ~2020.09.03
	 */
	CharSortedMap<ENTRY_SET> subMap(char beginKey, char endKey);
	 ...
	 * @since 0.1.5 ~2020.09.03
	 */
	CharSortedMap<ENTRY_SET> tailMap(char beginKey);
}
