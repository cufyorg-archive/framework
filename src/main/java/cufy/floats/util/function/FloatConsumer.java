 ...
 * most other functional interfaces, {@code FloatConsumer} is expected to operate via side-effects.
 * <p>
 * This is a {@code functional interface} whose functional method is {@link #accept(float)}.
 *
 * @author LSafer
 * @version 0.1.5
...
public interface FloatConsumer {
	/**
	 * Returns a composed {@code FloatConsumer} that performs, in sequence, this operation followed
