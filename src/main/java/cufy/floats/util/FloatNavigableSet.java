 ...
 */
package cufy.floats.util;

import cufy.floats.util.function.*;
...
public interface FloatNavigableSet extends FloatSortedSet, PrimitiveNavigableSet<
	 ...
	 * default float value} if no such element.
	 *
	 * @param element the value to match.
	 * @return the least element greater than {@code element}, or the {@code default float value} if
	 * 		no such element.
	 * @since 0.1.5 ~2020.09.01
	 */
	 ...
	 *
	 * @param element the value to match.
	 * @return the greatest element less than {@code element}, or the {@code default float value} if
	 * 		no such element.
	 * @since 0.1.5 ~2020.09.01
	 */
	...
	/**
	 * Retrieves and removes the first (lowest) element, or the {@code default float value} if no
	 * such element.
	 *
	 * @return the first element, or the {@code default float value} if no such element.
	 * @since 0.1.5 ~2020.09.01
	 */
	float pollFirstFloat();

	/**
	 * Retrieves and removes the last (highest) element, or the {@code default float value} if no
	 * such element.
	 *
	 * @return the last element, or the {@code default float value} if no such element.
	 * @since 0.1.5 ~2020.09.01
	 */
	float pollLastFloat();
