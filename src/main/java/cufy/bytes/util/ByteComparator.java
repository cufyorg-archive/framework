...
import cufy.bytes.util.function.ByteToDoubleFunction;
import cufy.bytes.util.function.ByteToIntFunction;
import cufy.bytes.util.function.ByteToLongFunction;
import cufy.bytes.util.function.ByteUnaryOperator;
