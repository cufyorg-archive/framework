 ...
 * @author LSafer
 * @version 0.1.3
 * @since 0.0.5 ~2019.12.27
 */
public class IllegalThreadException extends ConcurrentException {
	/**
	 * Constructs a new illegal access exception with null as its detail message. The cause is not initialized, and may
	...
	/**
	 * Constructs a new illegal access exception with the specified detail message. The cause is not initialized, and
	...
	/**
	 * Constructs a new illegal access exception with the specified detail message and cause. Note that the detail
	 * message associated with cause is not automatically incorporated in this illegal access exception's detail
	 * message.
	 *
	...
	/**
	 * Constructs a new illegal access exception with the specified cause and a detail message of (cause==null ? null :
	 * cause.toString()) (which typically contains the class and detail message of cause). This constructor is useful
	 * for illegal access exceptions that are little more than wrappers for other throwables.
	 *
	...
	/**
	 * Constructs a new illegal access exception with the specified detail message, cause, suppression enabled or
