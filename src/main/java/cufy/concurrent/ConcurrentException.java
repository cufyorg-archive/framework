...
public class ConcurrentException extends RuntimeException {
	/**
	 * Constructs a new concurrent exception with null as its detail message. The cause is not initialized, and may
	...
	/**
	 * Constructs a new concurrent exception with the specified detail message. The cause is not initialized, and may
	 * subsequently be initialized by a call to Throwable.initCause(java.lang.Throwable).
	 *
	...
	/**
	 * Constructs a new concurrent exception with the specified detail message and cause. Note that the detail message
	 * associated with cause is not automatically incorporated in this concurrent exception's detail message.
	 *
	...
	/**
	 * Constructs a new concurrent exception with the specified cause and a detail message of (cause==null ? null :
	 * cause.toString()) (which typically contains the class and detail message of cause). This constructor is useful
	 * for concurrent exceptions that are little more than wrappers for other throwables.
	 *
	...
	/**
	 * Constructs a new concurrent exception with the specified detail message, cause, suppression enabled or disabled,
