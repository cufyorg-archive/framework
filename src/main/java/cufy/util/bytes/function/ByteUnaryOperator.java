...
/**
 * Represents an operation on a single {@code byte}-valued operand that produces a {@code
 * byte}-valued result. This is the primitive type specialization of {@link UnaryOperator} for
 * {@code byte}.
 * <p>
