 ...
 */
public final class ShortArrayIterator implements ListIterator<Short> {
	/**
	 * The backing array.
	 */
	 ...
	 * @since 0.1.5 ~2020.07.24
	 */
	public ShortArrayIterator(int index, short... array) {
		Objects.requireNonNull(array, "array");
	 ...
	 * @since 0.1.5 ~2020.07.24
	 */
	public ShortArrayIterator(int cursor, int index, short... array) {
		Objects.requireNonNull(array, "array");
		Objects.require(index, Objects::nonNegative, ArrayIndexOutOfBoundsException.class, "index");
	 ...
	 * @since 0.1.5 ~2020.07.24
	 */
	public ShortArrayIterator(int cursor, int index, int length, short... array) {
		Objects.requireNonNull(array, "array");
