 ...
 */
public final class FloatArrayIterator implements ListIterator<Float> {
	/**
	 * The backing array.
	 */
	 ...
	 * @since 0.1.5 ~2020.07.24
	 */
	public FloatArrayIterator(int index, float... array) {
		Objects.requireNonNull(array, "array");
	 ...
	 * @since 0.1.5 ~2020.07.24
	 */
	public FloatArrayIterator(int cursor, int index, float... array) {
		Objects.requireNonNull(array, "array");
		Objects.require(index, Objects::nonNegative, ArrayIndexOutOfBoundsException.class, "index");
	 ...
	 * @since 0.1.5 ~2020.07.24
	 */
	public FloatArrayIterator(int cursor, int index, int length, float... array) {
		Objects.requireNonNull(array, "array");
