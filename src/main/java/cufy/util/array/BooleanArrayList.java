 ...
 */
public final class BooleanArrayList implements List<Boolean>, Serializable, RandomAccess {
	 ...
	 * @since 0.1.5 ~2020.07.24
	 */
	public BooleanArrayList(int index, boolean... array) {
		Objects.requireNonNull(array, "array");
	 ...
	 * @since 0.1.5 ~2020.07.24
	 */
	public BooleanArrayList(int index, int length, boolean... array) {
		Objects.requireNonNull(array, "array");
		Objects.require(index, Objects::nonNegative, ArrayIndexOutOfBoundsException.class, "index");
	 ...
	 * @since 0.1.5 ~2020.07.24
	 */
	public static final class Iterator implements ListIterator<Boolean> {
		/**
		 * The backing array.
		 */
		private final boolean[] array;
		 ...
		 * @since 0.1.5 ~2020.07.24
		 */
		public Iterator(int index, boolean... array) {
			Objects.requireNonNull(array, "array");
			Objects.require(index, Objects::nonNegative, ArrayIndexOutOfBoundsException.class, "index");
			Objects.require(index, array.length, Objects::nonGreater, ArrayIndexOutOfBoundsException.class, "index");
			this.index = index;
		 ...
		 * @since 0.1.5 ~2020.07.24
		 */
		public Iterator(int cursor, int index, boolean... array) {
			Objects.requireNonNull(array, "array");
			Objects.require(index, Objects::nonNegative, ArrayIndexOutOfBoundsException.class, "index");
		 ...
		 * @since 0.1.5 ~2020.07.24
		 */
		public Iterator(int cursor, int index, int length, boolean... array) {
			Objects.requireNonNull(array, "array");
