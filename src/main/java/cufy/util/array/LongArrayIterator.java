 ...
 */
public final class LongArrayIterator implements ListIterator<Long> {
	/**
	 * The backing array.
	 */
	 ...
	 * @since 0.1.5 ~2020.07.24
	 */
	public LongArrayIterator(int index, long... array) {
		Objects.requireNonNull(array, "array");
	 ...
	 * @since 0.1.5 ~2020.07.24
	 */
	public LongArrayIterator(int cursor, int index, long... array) {
		Objects.requireNonNull(array, "array");
		Objects.require(index, Objects::nonNegative, ArrayIndexOutOfBoundsException.class, "index");
	 ...
	 * @since 0.1.5 ~2020.07.24
	 */
	public LongArrayIterator(int cursor, int index, int length, long... array) {
		Objects.requireNonNull(array, "array");
