 ...
 */
public final class IntegerArrayIterator implements ListIterator<Integer> {
	/**
	 * The backing array.
	 */
	 ...
	 * @since 0.1.5 ~2020.07.24
	 */
	public IntegerArrayIterator(int index, int... array) {
		Objects.requireNonNull(array, "array");
	 ...
	 * @since 0.1.5 ~2020.07.24
	 */
	public IntegerArrayIterator(int cursor, int index, int... array) {
		Objects.requireNonNull(array, "array");
		Objects.require(index, Objects::nonNegative, ArrayIndexOutOfBoundsException.class, "index");
	 ...
	 * @since 0.1.5 ~2020.07.24
	 */
	public IntegerArrayIterator(int cursor, int index, int length, int... array) {
		Objects.requireNonNull(array, "array");
