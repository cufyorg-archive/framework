 ...
 */
public final class IntegerArrayList implements List<Integer>, Serializable, RandomAccess {
	//todo sort
	 ...
	 * @since 0.1.5 ~2020.07.24
	 */
	public IntegerArrayList(int... array) {
	 ...
	 * @since 0.1.5 ~2020.07.24
	 */
	public IntegerArrayList(int index, int... array) {
		Objects.requireNonNull(array, "array");
	 ...
	 * @since 0.1.5 ~2020.07.24
	 */
	public IntegerArrayList(int index, int length, int... array) {
		Objects.requireNonNull(array, "array");
		Objects.require(index, Objects::nonNegative, ArrayIndexOutOfBoundsException.class, "index");
	 ...
	 * @since 0.1.5 ~2020.07.24
	 */
	public static final class Iterator implements ListIterator<Integer> {
		/**
		 * The backing array.
		 */
		private final int[] array;
		 ...
		 * @since 0.1.5 ~2020.07.24
		 */
		public Iterator(int index, int... array) {
			Objects.requireNonNull(array, "array");
			Objects.require(index, Objects::nonNegative, ArrayIndexOutOfBoundsException.class, "index");
			Objects.require(index, array.length, Objects::nonGreater, ArrayIndexOutOfBoundsException.class, "index");
			this.index = index;
		 ...
		 * @since 0.1.5 ~2020.07.24
		 */
		public Iterator(int cursor, int index, int... array) {
			Objects.requireNonNull(array, "array");
			Objects.require(index, Objects::nonNegative, ArrayIndexOutOfBoundsException.class, "index");
		 ...
		 * @since 0.1.5 ~2020.07.24
		 */
		public Iterator(int cursor, int index, int length, int... array) {
			Objects.requireNonNull(array, "array");
