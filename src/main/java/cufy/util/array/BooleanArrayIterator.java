 ...
 */
public final class BooleanArrayIterator implements ListIterator<Boolean> {
	/**
	 * The backing array.
	 */
	 ...
	 * @since 0.1.5 ~2020.07.24
	 */
	public BooleanArrayIterator(int index, boolean... array) {
		Objects.requireNonNull(array, "array");
	 ...
	 * @since 0.1.5 ~2020.07.24
	 */
	public BooleanArrayIterator(int cursor, int index, boolean... array) {
		Objects.requireNonNull(array, "array");
		Objects.require(index, Objects::nonNegative, ArrayIndexOutOfBoundsException.class, "index");
	 ...
	 * @since 0.1.5 ~2020.07.24
	 */
	public BooleanArrayIterator(int cursor, int index, int length, boolean... array) {
		Objects.requireNonNull(array, "array");
