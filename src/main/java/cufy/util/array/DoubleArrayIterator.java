 ...
 */
public final class DoubleArrayIterator implements ListIterator<Double> {
	/**
	 * The backing array.
	 */
	 ...
	 * @since 0.1.5 ~2020.07.24
	 */
	public DoubleArrayIterator(int index, double... array) {
		Objects.requireNonNull(array, "array");
	 ...
	 * @since 0.1.5 ~2020.07.24
	 */
	public DoubleArrayIterator(int cursor, int index, double... array) {
		Objects.requireNonNull(array, "array");
		Objects.require(index, Objects::nonNegative, ArrayIndexOutOfBoundsException.class, "index");
	 ...
	 * @since 0.1.5 ~2020.07.24
	 */
	public DoubleArrayIterator(int cursor, int index, int length, double... array) {
		Objects.requireNonNull(array, "array");
