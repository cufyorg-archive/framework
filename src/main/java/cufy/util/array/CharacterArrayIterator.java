 ...
 */
public final class CharacterArrayIterator implements ListIterator<Character> {
	/**
	 * The backing array.
	 */
	 ...
	 * @since 0.1.5 ~2020.07.24
	 */
	public CharacterArrayIterator(int index, char... array) {
		Objects.requireNonNull(array, "array");
	 ...
	 * @since 0.1.5 ~2020.07.24
	 */
	public CharacterArrayIterator(int cursor, int index, char... array) {
		Objects.requireNonNull(array, "array");
		Objects.require(index, Objects::nonNegative, ArrayIndexOutOfBoundsException.class, "index");
	 ...
	 * @since 0.1.5 ~2020.07.24
	 */
	public CharacterArrayIterator(int cursor, int index, int length, char... array) {
		Objects.requireNonNull(array, "array");
