...
/**
 * Represents an operation on a single {@code float}-valued operand that produces a {@code
 * float}-valued result. This is the primitive type specialization of {@link UnaryOperator} for
 * {@code float}.
 * <p>
 * This is a {@code functional interface} whose functional method is {@link #applyAsFloat(float)}.
 *
 * @author LSafer
 * @version 0.1.5
