 ...
 * the {@code float}-consuming primitive type specialization of {@link Predicate}.
 * <p>
 * This is a {@code functional interface} whose functional method is {@link #test(float)}.
 *
 * @author LSafer
 * @version 0.1.5
